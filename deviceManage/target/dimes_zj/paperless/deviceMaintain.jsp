...
_deviceSiteCode = parent.$("#deviceCode").val();
    ...
    $(function() {
        ...
        $.ajax({
                    ...
                    productionUnitId:<%=productionUnit==null?null:productionUnit.getId() %>
                   },
                       ...
                       if(data!=null&&data.length>0){
                           $.each(data, function (index, item) {
                               ...
                               str += '<tr>' +
                                   ...
                                   '<td>' + employeeName + '</td>' +
                                   '<td>' + confirmName + '</td>' +
                                   '<td style="width:100px;"><a href="javascript:void(0);" style="font-size:20px" onclick="parent.showM('+item.id+','+"'"+lookStatus+"'"+')">'+lookStatus+'</a></td>' +
                                   '</tr>';
                               /*if(item.status=='已完成'){
                                               str += '<tr>' +
                                                   '<td>' + (index+1) + '</td>' +
