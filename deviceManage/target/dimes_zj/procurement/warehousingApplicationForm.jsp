...
<sec:authorize access="hasAuthority('QUERY_WAREHOUSINGAPPLICATIONFORM')">
...
<sec:authorize access="hasAuthority('EXPORT_WAREHOUSINGAPPLICATIONFORM')">
    <a href="javascript:void(0)"
       data-toggle="topjui-menubutton"
       data-options="iconCls: 'fa fa-sign-out'"
    >导出</a>
</sec:authorize>
<sec:authorize access="hasAuthority('ADD_WAREHOUSINGAPPLICATIONFORM')">
    <a href="javascript:void(0)"
       data-toggle="topjui-menubutton"
       data-options="extend: '#warehousingApplicationFormDetailDg-toolbar',
       iconCls: 'fa fa-plus'" onclick="addWarehousingApplicationForm()">新增</a>
</sec:authorize>
<sec:authorize access="hasAuthority('DEL_WAREHOUSINGAPPLICATIONFORM')">
    <a href="javascript:void(0)"
       data-toggle="topjui-menubutton"
       data-options="iconCls:'fa fa-trash'" onclick="deleteWarehousingApplicationForm()">删除</a>
</sec:authorize>
<sec:authorize access="hasAuthority('SEE_WAREHOUSINGAPPLICATIONFORM')">
    <a href="javascript:void(0)"
       data-toggle="topjui-menubutton"  data-options="extend: '#warehousingApplicationFormDetailDg-toolbar',
       iconCls: 'fa fa-eye'" onclick="queryWarehousingApplicationFormDetailsByFormNo()">查看</a>
</sec:authorize>
<sec:authorize access="hasAuthority('EXAMINE_WAREHOUSINGAPPLICATIONFORM')">
    <a href="javascript:void(0)"
       data-toggle="topjui-menubutton"
       data-options="iconCls:'fa fa-check-square-o'" id="audit" onclick="auditAtForm()">审核</a>
</sec:authorize>
<sec:authorize access="hasAuthority('REVERSEEXAMINE_WAREHOUSINGAPPLICATIONFORM')">
    <a href="javascript:void(0)"
       data-toggle="topjui-menubutton"
    ...
    <form id="searchForm" style="margin-top: 10px;margin-left: 10px;">
        ...
        供应商:<input id="vendor" data-toggle="topjui-textbox" style="width:10%" data-options="prompt:'编码或名称'">
