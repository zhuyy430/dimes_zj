...
<div data-toggle="topjui-layout" data-options="fit:true">
	<div
		...
		<table data-toggle="topjui-datagrid" data-options="id:'locationTable',
			...
			<thead>
			<tr>
				<th data-options="field:'id',checkbox:true,title:'id',width:'50px',align:'center'"></th>
				<th data-options="field:'cPosCode',title:'编码',width:'48%',align:'center'"></th>
				<th data-options="field:'cPosName',title:'货位名称',width:'48%',align:'center'"></th>
			</tr>
			</thead>
		</table>
	</div>
