				...
				<div class="topjui-row">
					<div class="topjui-col-sm12">
						...
						<div class="topjui-input-block">
								<input id="deviceSiteId" data-toggle="topjui-combobox" name="deviceSiteId" 
								data-options="valueField:'id',textField:'name',
								url:'deviceSite/queryAllDeviceSitesByDeviceId.do?deviceId='+$('#deviceDg').iDatagrid('getSelected').id,
						        onLoadSuccess: function () { //加载完成后,val[0]写死设置选中第一项
						            ...
						            onSelect:function(data){
						            	$('#parameterId').iCombogrid('grid').iDatagrid('reload',{deviceSiteId:data.id});
						            }
						            ,required:true">
