        ...
        <div data-toggle="topjui-layout" data-options="fit:true">
            <div data-options="region:'center',title:'',fit:false,split:true,border:false,bodyCls:'border_bottom'"
                ...
                data-toggle="topjui-datagrid"
                       ...
                       url:'qualityCalendarType/queryQualityCalendarTypes.do',
                       singleSelect:true,
                       fitColumns:true,
                       pagination:true,
...
<div id="departmentDg-toolbar" class="topjui-toolbar"
     data-options="grid:{
       ...
       <sec:authorize access="hasAuthority('ADD_QUALITYCALENDARTYPE')">
    <a href="javascript:void(0)"
       ...
       dialog:{
           ...
           width:600,
           height:600,
           href:'console/jsp/qualityType_add.jsp',
           buttons:[
           	{text:'保存',handler:function(){
           			var code = $('#code').val();
           			if(code==null || ''===$.trim(code)){
           				$.iMessager.alert('提示','请输入类型代码');
           				return false;
           			}
           			...
           			$.get('qualityCalendarType/addQualityCalendarType.do',{
           			code:code,
           			name:name,
           			note:$('#note').val()
           			},function(data){
           ...
           <sec:authorize access="hasAuthority('EDIT_QUALITYCALENDARTYPE')">
    <a href="javascript:void(0)"
       data-toggle="topjui-menubutton"
       data-options="method: 'openDialog',
            extend: '#departmentDg-toolbar',
            ...
            dialog: {
                ...
                width: 600,
                height: 400,
                href: 'console/jsp/qualityType_edit.jsp',
                url:'qualityCalendarType/queryQualityCalendarTypeById.do?id={id}',
                 buttons:[
           	{text:'编辑',handler:function(){
           			...
           			$.get('qualityCalendarType/updateQualityCalendarType.do',{
            ...
            <sec:authorize access="hasAuthority('DEL_QUALITYCALENDARTYPE')">
    <a href="javascript:void(0)"
       data-toggle="topjui-menubutton"
       data-options="method:'doAjax',
       extend: '#departmentDg-toolbar',
       iconCls:'fa fa-trash',
       url:'qualityCalendarType/deleteQualityCalendarType.do',
