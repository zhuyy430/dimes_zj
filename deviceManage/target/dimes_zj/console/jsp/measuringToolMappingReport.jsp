...
<script type="text/javascript">
 $(function(){
	...
	$("#searchBtn").click(function(){
		  $("#departmentDg").iDatagrid("reload",'report/queryMeasuringMappingCountReport.do?'+$("#searchForm").serialize());
	});
	...
	$('#equipmentTable').iDatagrid({
	    ...
	    columns:[[
	        ...
	        {field:'code',title:'量具代码',width:100},
	        {field:'name',title:'量具名称',width:100}
	    ]]/* ,
	    queryParams:{
...
<body>
			...
			<div data-toggle="topjui-layout" data-options="fit:true">
				<div
					...
					<table data-toggle="topjui-datagrid"
                       ...
                       url:'report/queryMeasuringMappingCountReport.do',
                       singleSelect:true,
                       fitColumns:true,
                       pagination:true,
	...
	<div id="departmentDg-toolbar" class="topjui-toolbar"
		...
		<form id="searchForm" method="post">
			...
			<span> <label for="equipmentCodes">量具代码:</label> <input
