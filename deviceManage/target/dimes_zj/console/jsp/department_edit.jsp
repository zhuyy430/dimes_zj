					...
					<div class="topjui-col-sm12">
						...
						<div class="topjui-input-block">
							<input type="text" name="code" readonly="readonly" data-toggle="topjui-textbox"
								data-options="required:true" id="deptCode_edit">
					...
					<div class="topjui-col-sm12">
						...
						<div class="topjui-input-block">
							<input type="text" name="name" data-toggle="topjui-textbox"
								data-options="required:true" id="deptName_edit">
						</div>
					</div>
				</div>
				<!-- <div class="topjui-row">
					<div class="topjui-col-sm8">
						...
						<div class="topjui-input-block">
							<input type="text" name="pname" id="pname" data-toggle="topjui-combobox"
								data-options="required:false,
                       valueField:'id',
                       textField:'name',
                       url:'department/queryOtherDepartments.do?id={id}',
					...
					<div class="topjui-col-sm12">
						...
						<div class="topjui-input-block">
							...
							<input type="text" name="note"
								data-toggle="topjui-textarea" id="deptNote_edit">
						</div>
					</div>
				</div>
			</div>
