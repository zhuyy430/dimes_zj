        ...
        <div data-toggle="topjui-layout" data-options="fit:true">
            <div data-options="region:'center',title:'',fit:false,split:true,border:false,bodyCls:'border_bottom'"
                ...
                data-toggle="topjui-datagrid"
                       ...
                       url:'qualityGrade/queryQualityGrades.do',
                       singleSelect:true,
                       fitColumns:true,
                       pagination:true,
                    ...
                    <tr>
                        ...
                        <th data-options="field:'code',title:'等级代码',width:'100px',align:'center'"></th>
                        <th data-options="field:'name',title:'等级名称',width:'100px',sortable:false"></th>
                        <th data-options="field:'note',title:'说明',width:'100px',sortable:false"></th>
                    </tr>
                    </thead>
                </table>
            </div>
...
<div id="departmentDg-toolbar" class="topjui-toolbar"
     data-options="grid:{
       ...
       <sec:authorize access="hasAuthority('ADD_QUALITYGRADE')">
    <a href="javascript:void(0)"
       ...
       dialog:{
           ...
           width:600,
           height:600,
           href:'console/jsp/qualityGrade_add.jsp',
           buttons:[
           	{text:'保存',handler:function(){
           			var code = $('#code').val();
           			if(code==null || ''===$.trim(code)){
           				$.iMessager.alert('提示','请输入等级代码');
           				return false;
           			}
           			...
           			$.get('qualityGrade/addQualityGrade.do',{
           			code:code,
           			name:name,
           			note:$('#note').val()
           			},function(data){
           ...
           <sec:authorize access="hasAuthority('EDIT_QUALITYGRADE')">
    <a href="javascript:void(0)"
       data-toggle="topjui-menubutton"
       data-options="method: 'openDialog',
            extend: '#departmentDg-toolbar',
            ...
            dialog: {
                ...
                width: 600,
                height: 400,
                href: 'console/jsp/qualityGrade_edit.jsp',
                url:'qualityGrade/queryQualityGradeById.do?id={id}',
                 buttons:[
           	{text:'编辑',handler:function(){
           			...
           			$.get('qualityGrade/updateQualityGrade.do',{
            ...
            <sec:authorize access="hasAuthority('DEL_QUALITYGRADE')">
    <a href="javascript:void(0)"
       data-toggle="topjui-menubutton"
       data-options="method:'doAjax',
       extend: '#departmentDg-toolbar',
       iconCls:'fa fa-trash',
       url:'qualityGrade/deleteQualityGrade.do',
