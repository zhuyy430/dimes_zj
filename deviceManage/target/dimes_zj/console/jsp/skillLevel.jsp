        ...
        <div data-toggle="topjui-layout" data-options="fit:true">
            <div data-options="region:'center',title:'',fit:false,split:true,border:false,bodyCls:'border_bottom'"
                ...
                data-toggle="topjui-datagrid"
                       ...
                       url:'skillLevel/querySkillLevels.do',
                       singleSelect:true,
                       fitColumns:true,
                       pagination:true,
...
<div id="departmentDg-toolbar" class="topjui-toolbar"
     data-options="grid:{
       ...
       <sec:authorize access="hasAuthority('ADD_SKILLLEVEL')">
    <a href="javascript:void(0)"
       ...
       dialog:{
           ...
           width:600,
           height:600,
           href:'console/jsp/skillLevel_add.jsp',
           buttons:[
           	{text:'保存',handler:function(){
           			...
           			$.get('skillLevel/addSkillLevel.do',{
           			code:code,
           			name:name,
           			note:$('#note').val()
           			},function(data){
           ...
           <sec:authorize access="hasAuthority('EDIT_SKILLLEVEL')">
    <a href="javascript:void(0)"
       data-toggle="topjui-menubutton"
       data-options="method: 'openDialog',
            extend: '#departmentDg-toolbar',
            ...
            dialog: {
                ...
                width: 600,
                height: 400,
                href: 'console/jsp/skillLevel_edit.jsp',
                url:'skillLevel/querySkillLevelById.do?id={id}',
                 buttons:[
           	{text:'编辑',handler:function(){
           			...
           			$.get('skillLevel/updateSkillLevel.do',{
