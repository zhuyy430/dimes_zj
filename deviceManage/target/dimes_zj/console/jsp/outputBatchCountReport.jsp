...
<script type="text/javascript">
 $(function(){
	...
	$("#searchBtn").click(function(){
		  $("#departmentDg").iDatagrid("reload",'report/queryOutputBatchCountReport.do?'+$("#searchForm").serialize());
	});
			...
			<div data-toggle="topjui-layout" data-options="fit:true">
				<div
					...
					<table data-toggle="topjui-datagrid"
                       ...
                       url:'report/queryOutputBatchCountReport.do',
                       singleSelect:true,
                       fitColumns:true,
                       pagination:true,
			           ...
			           onSelect:function(index,row){
						...
						<thead>
							<tr>
								...
								<th
									data-options="field:'batchNumber',title:'批号',width:'100px',align:'center',formatter:function(value,row,index){
                            		return row[7];
                        		}"></th>
								<th
									data-options="field:'stoveNumber',title:'材料编号',width:'100px',align:'center',formatter:function(value,row,index){
                            		return row[8];
                        		}"></th>
								<th
		...
		<form id="searchForm" method="post">
			<div>
				<span> <label for="productionUnitId">生产单元: </label> <input
					...
					style="width: 200px;">
				</span> <span> <label for="batchNumber">批&nbsp;&nbsp;号:</label> <input
					type="text" name="batchNumber" id="batchNumber" data-toggle="topjui-textbox" style="width:200px;"></span>
			...
			<div id="search" hidden="hidden" style="margin-left: 2px;margin-top: 8px" >
				...
				<span> <label for="deviceSiteCodes">站点代码:</label> <input
					type="text" name="deviceSiteCodes" id="deviceSiteCodes" >
				</span> 
				<span> <label for="processess">工&nbsp;&nbsp;序:</label> <input
