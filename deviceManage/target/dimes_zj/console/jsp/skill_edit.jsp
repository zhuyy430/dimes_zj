				...
				<div class="topjui-fluid">
					...
					<div class="topjui-row">
						<div class="topjui-col-sm12">
							<label class="topjui-form-label">技能代码</label>
					...
					<div class="topjui-row">
						<div class="topjui-col-sm12">
							<label class="topjui-form-label">技能名称</label>
							<div class="topjui-input-block">
					...
					<div class="topjui-row">
						<div class="topjui-col-sm12">
							<label class="topjui-form-label">技能类别</label>
							<div class="topjui-input-block">
								<input id="skillTypeName" name="skillTypeName"
									data-toggle="topjui-combobox"
									data-options="
							        valueField: 'name',
							        textField: 'name',
							        editable:true,
							        url: 'skill/queryAllSkillTypes.do'">
							</div>
						</div>
					</div>
					<div class="topjui-row">
