		...
		$(function(){
			$('#deviceTable').iDatagrid({
			    ...
			    columns:[[
			        ...
			        {field:'productionUnit',title:'生产单元',width:130,
...
<div data-options="region:'north',title:'',border:false,height:40">
		<div style="height: 30px;margin-top:2px;margin-left:10px;">
			<div style="width:100%;">
				...
				生产单元:<input id="productionUnitName" 
					name="productionUnitName" style="width:100px;height:25px;padding-left:2px;border:1px solid #D3D3D3;">
