			...
			$('#pressLightType').iCombogrid(
					{
						...
						onChange : function(newValue, oldValue) {
							$('#pressLightTable').iDatagrid("reload",{projectTypeId:$("#pressLightType").val(),type:"BREAKDOWNREASON",deviceRepairId : $("#deviceDg").iDatagrid("getSelected").id});
						}
					}); 
			$('#pressLightTable').iDatagrid({
				idField : 'id',
				 fitColumns:true,
		            ...
		            selectOnCheck:true,
		            checkOnSelect:false,
			    url:'deviceProject/queryDevicesProjectByDeviceRepairId.do',
