...
<div data-toggle="topjui-layout" data-options="fit:true">
	<div
		...
		<form id="addDeviceForm" method="post">
			<div title="设备管理-新增" data-options="iconCls:'fa fa-th'">
				...
				<div style="height:20px;"></div>
					...
					<div class="topjui-row">
						<div class="topjui-col-sm6">
							...
							<div class="topjui-input-block">
							    <input id="projectType" name="projectType" data-toggle="topjui-combogrid" data-options="required:true">
							</div>
						</div>
						<div class="topjui-col-sm6">
							<label class="topjui-form-label" style="text-align: center;">设备等级</label>
							<div class="topjui-input-block">
							    <input id="deviceLevel" name="deviceLevel" data-toggle="topjui-combogrid" data-options="required:true">
							</div>
						</div>
						</div>
						<div class="topjui-row">
