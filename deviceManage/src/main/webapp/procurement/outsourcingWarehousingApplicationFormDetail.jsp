...
<sec:authorize access="hasAuthority('OS_ADDLINE_WAREHOUSINGAPPLICATIONFORMDETAIL')">
    <a href="javascript:void(0)"
       data-toggle="topjui-menubutton" data-options="iconCls: 'fa fa-plus'"
       onclick="addLines()" id="addLineBtn">添加行</a>
</sec:authorize>
<sec:authorize access="hasAuthority('OS_DELLINE_WAREHOUSINGAPPLICATIONFORMDETAIL')">
    <a href="javascript:void(0)"
       data-toggle="topjui-menubutton"  data-options="iconCls: 'fa fa-trash'"
       onclick="deleteLine()" id="deleteLineBtn">删除行</a>
</sec:authorize>
<sec:authorize access="hasAuthority('OS_SPLITBOX_WAREHOUSINGAPPLICATIONFORMDETAIL')">
...
<sec:authorize access="hasAuthority('OS_SAVE_WAREHOUSINGAPPLICATIONFORMDETAIL')">
...
<sec:authorize access="hasAuthority('OS_EXAMINE_WAREHOUSINGAPPLICATIONFORMDETAIL')">
...
<sec:authorize access="hasAuthority('OS_REVERSEEXAMINE_WAREHOUSINGAPPLICATIONFORMDETAIL')">
...
<sec:authorize access="hasAuthority('OS_BOXBAR_WAREHOUSINGAPPLICATIONFORMDETAIL')">
...
<sec:authorize access="hasAuthority('OS_PRINT_WAREHOUSINGAPPLICATIONFORMDETAIL')">
...
<sec:authorize access="hasAuthority('OS_INWAREHOUSE_WAREHOUSINGAPPLICATIONFORMDETAIL')">
            ...
            <div class="topjui-fluid">
                ...
                <div class="topjui-row">
                    <div class="topjui-col-sm4">
                        ...
                        <div class="topjui-input-block">
                            <input type="text" name="vendor" data-toggle="topjui-textbox" id="vendor" data-options="required:true" readonly="true">
