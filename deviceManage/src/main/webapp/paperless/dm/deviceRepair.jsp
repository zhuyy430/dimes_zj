          	...
          	type : "post",
	            ...
	            success : function(data) {
	            	if(data){
	            			...
	            			$("#Informant").val("<%=((Employee)session.getAttribute("employee"))==null?"":((Employee)session.getAttribute("employee")).getName()%>");
	...
	if($('#pressLightId').val()==""){
	 ...
	 $.ajax({
			...
			data : {	
                ...
                "idList":$('#photoIds').val(),
                "employeeCode":"<%=((Employee)session.getAttribute("employee"))==null?"":((Employee)session.getAttribute("employee")).getCode()%>"
			},
			dataType : "json",
			success : function(data) {
				if(data.success){
