...
<script>
	$(function() {
		$('#processesDeviceSiteTable').iDatagrid(
				{
					url : 'workSheet/queryOtherDeviceSitesByProcessId.do',
					columns : [ [ {
						field : 'id',
						title : 'id',
						checkbox : true
					...
					queryParams : {
						processId : $("#workSheetDetail").iDatagrid(
								"getSelected").processId,
						productionUnitId:$("#productionUnitTg").iTreegrid("getSelected").id
					}
				});
	});
</script>
<div data-toggle="topjui-layout" data-options="fit:true">
	<div
		data-options="region:'center',title:'',fit:false,border:false,bodyCls:'border_right_bottom'">
