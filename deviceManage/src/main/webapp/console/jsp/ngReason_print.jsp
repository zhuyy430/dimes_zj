		...
		$(function(){
			var ids = window.opener.document.getElementById("ids").value;
			 $.get("ngReason/printQr.do",{ids:ids},function(data){
				 ...
				 var pressLight = data[data.length-1];
				 if(pressLight){
					 $processInfo.append(pressLight.processCode + " " + pressLight.processName);
				 }
			 });
		});
...
<div data-toggle="topjui-layout" data-options="fit:true">
	...
	<div
		...
		<table id="ngTable">
			...
			<caption style="font-size:40px;">不良原因 &nbsp;&nbsp;
				<span style="font-size:24px" id="processInfo"></span>
			</caption>
			<thead>
				<tr>
					<th class="content"> NG代码</th>
