        ...
        <div data-toggle="topjui-layout" data-options="fit:true">
            <div data-options="region:'center',title:'',fit:false,split:true,border:false,bodyCls:'border_bottom'"
                ...
                data-toggle="topjui-datagrid"
                       ...
                       url:'secureEnvironmentGrade/querySecureEnvironmentGrades.do',
                       singleSelect:true,
                       fitColumns:true,
                       pagination:true,
                    ...
                    <tr>
                        ...
                        <th data-options="field:'name',title:'等级名称',width:'100px',align:'center'"></th>
                        <th data-options="field:'weight',title:'等级级别',width:'100px',align:'center',formatter:function(value,row,index){
                        	if(value){
                        		switch(value){
                        			case 1:return '一级';
                        			case 2:return '二级';
                        ...
                        <th data-options="field:'color',title:'颜色',width:'100px',align:'center',styler: function(value,row,index){
			                if (value){
			                    return 'background-color:' + value;
			                }
			            }"></th>
                        <th data-options="field:'note',title:'说明',width:'100px',align:'center'"></th>
                    </tr>
                    </thead>
                </table>
            </div>
...
<sec:authorize access="hasAuthority('ADD_SECUREENVIRONMENTGRADE')">
    <a href="javascript:void(0)"
       ...
       dialog:{
           ...
           width:600,
           height:600,
           href:'console/jsp/secureEnvironmentGrade_add.jsp',
           buttons:[
           	{text:'保存',handler:function(){
           			...
           			$.get('secureEnvironmentGrade/addSecureEnvironmentGrade.do',{
           			code:code,
           			name:name,
           			weight:$('#weight').iCombobox('getValue'),
           			color:$('#color').iTextbox('getValue'),
           			note:$('#note').val()
           			},function(data){
           				if(data.success){
...
<sec:authorize access="hasAuthority('EDIT_ SECUREENVIRONMENTGRADE')">
    <a href="javascript:void(0)"
       data-toggle="topjui-menubutton"
       data-options="method: 'openDialog',
            extend: '#departmentDg-toolbar',
            ...
            dialog: {
                ...
                width: 600,
                height: 400,
                href: 'console/jsp/secureEnvironmentGrade_edit.jsp',
                url:'secureEnvironmentGrade/querySecureEnvironmentGradeById.do?id={id}',
                 buttons:[
           	{text:'编辑',handler:function(){
           			...
           			$.get('secureEnvironmentGrade/updateSecureEnvironmentGrade.do',{
...
<sec:authorize access="hasAuthority('DEL_ SECUREENVIRONMENTGRADE')">
    <a href="javascript:void(0)"
       data-toggle="topjui-menubutton"
       data-options="method:'doAjax',
       extend: '#departmentDg-toolbar',
       iconCls:'fa fa-trash',
       url:'secureEnvironmentGrade/deleteSecureEnvironmentGrade.do',
