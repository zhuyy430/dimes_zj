    ...
    <div data-options="region:'west',title:'',split:true,border:false,width:'15%',iconCls:'fa fa-sitemap',headerCls:'border_right',bodyCls:'border_right'">
        ...
        <table
         data-toggle="topjui-treegrid"
			   ...
			   fit:true,
			   singleSelect:true,
			   url:'pressLightType/queryTopPressLightTypes.do?type=PRESSLIGHTTYPE',
			   childGrid:{
            ...
            <tr>
               <!--  <th data-options="field:'id',title:'id',checkbox:true"></th> -->
                <th data-options="field:'name',width:'100%',title:'损时类别'"></th>
            </tr>
            </thead>
        </table>
    </div>
        ...
        <div data-toggle="topjui-layout" data-options="fit:true">
            <div data-options="region:'center',title:'',fit:false,split:true,border:false,bodyCls:'border_bottom'"
                ...
                data-toggle="topjui-datagrid"
                       ...
                       url:'pressLightType/queryPressLightTypesByParentId.do?type=PRESSLIGHTTYPE',
                       singleSelect:true,
                       fitColumns:true,
                       pagination:true,
                       parentGrid:{
            ...
            <div data-options="region:'south',fit:false,split:true,border:false"
                ...
                <div data-toggle="topjui-tabs"
                    ...
                    <div title="损时原因信息" data-options="id:'tab0',iconCls:'fa fa-th'">
                        <!-- datagrid表格 -->
                        <table 
                         data-toggle="topjui-datagrid"
                               ...
                               initCreate: false,
								...
								checkOnSelect:false,
                               fitColumns:true,
						       url:'pressLight/queryPressLightsByPressLightTypeId.do?type=PRESSLIGHTTYPE'">
                            <thead>
                            <tr>
                                <th data-options="field:'id',title:'id',checkbox:true"></th>
                                <th data-options="field:'code',title:'损时原因代码',width:'180px',align:'center'"></th>
                                <th data-options="field:'reason',title:'损时原因',width:'180px',align:'center'"></th>
                                <th data-options="field:'description',title:'详细描述',width:'180px',align:'center'"></th>
                                <th data-options="field:'halt',title:'是否停机',width:'180px',align:'center',formatter:function(value,rows,index){
                                	if(value){
                                		return 'Y';
                                	}else{
                                		return 'N';
                                ...
                                <th data-options="field:'planHalt',title:'计划停机',width:'180px',align:'center',formatter:function(value,rows,index){
                                	if(value){
                                		return 'Y';
                                	}else{
                                		return 'N';
...
<sec:authorize access="hasAuthority('ADDType_PRESSLIGHT')">
...
<sec:authorize access="hasAuthority('EDITTYPE_PRESSLIGHT')">
    <a href="javascript:void(0)"
       data-toggle="topjui-menubutton"
       data-options="method: 'openDialog',
            extend: '#departmentDg-toolbar',
...
<sec:authorize access="hasAuthority('DELTYPE_PRESSLIGHT')">
    <a href="javascript:void(0)"
       data-toggle="topjui-menubutton"
...
<sec:authorize access="hasAuthority('DISABLETYPE_PRESSLIGHT')">
    <a href="javascript:void(0)"
       data-toggle="topjui-menubutton"
       data-options="method:'doAjax',
       extend: '#departmentDg-toolbar',
...
<sec:authorize access="hasAuthority('ADD_PRESSLIGHT')">
    <a href="javascript:void(0)"
       data-toggle="topjui-menubutton"
       data-options="method:'openDialog',
...
<sec:authorize access="hasAuthority('EDIT_PRESSLIGHT')">
    <a href="javascript:void(0)"
       data-toggle="topjui-menubutton"
       data-options="method: 'openDialog',
            extend: '#position-toolbar',
...
<sec:authorize access="hasAuthority('DEL_PRESSLIGHT')">
    <a href="javascript:void(0)"
       data-toggle="topjui-menubutton"
       data-options="method:'doAjax',
       extend: '#position-toolbar',
