    ...
    <div data-options="region:'center',iconCls:'icon-reload',title:'',split:true,border:true,bodyCls:'border_top_none'">
        ...
        <div
			...
			<table id="departmentTg" data-toggle="topjui-treegrid"
			   ...
			   fit:true,
			   singleSelect:true,
			   url:'deviceLevel/queryTopDeviceLevels.do',
			   queryParams:{
			   ...
			   childGrid:{
				...
				<thead>
					<tr>
						...
						<th data-options="field:'name',width:'100%',title:'设备等级'"></th>
					</tr>
				</thead>
			</table>
		</div>
            <div data-options="region:'center',title:'',fit:false,split:true,border:false,bodyCls:'border_bottom'"
                ...
                data-toggle="topjui-datagrid"
                       ...
                       url:'deviceLevel/queryDeviceLevelsByParentId.do',
                       singleSelect:true,
                       fitColumns:true,
                       pagination:true,
                    ...
                    <tr>
                        ...
                        <th data-options="field:'weight',title:'等级权重',width:'180px',align:'center'"></th>
                        <th data-options="field:'note',title:'备注',width:'180px',align:'center'"></th>
                        <!-- <th data-options="field:'parentCode',title:'上级等级代码',width:'180px',align:'center',formatter:function(value,row,index){
                        	if(row.parent){
                        ...
                        <th data-options="field:'parentName',title:'上级等级名称',width:'180px',align:'center',formatter:function(value,row,index){
                        	if(row.parent){
...
<sec:authorize access="hasAuthority('ADD_DEVICE_GRADE')">
    <a href="javascript:void(0)"
       ...
       dialog:{
           ...
           width:600,
           height:600,
           href:'console/jsp/deviceManagement/deviceLevel_add.jsp',
           buttons:[
           	{text:'保存',handler:function(){
           			var code = $('#code').val();
           			if(code==null || ''===$.trim(code)){
           				$.iMessager.alert('提示','请输入设备等级代码!');
           				return false;
           			}
           			
           			var name = $('#name').val();
           			if(name==null || ''===$.trim(name)){
           				$.iMessager.alert('提示','请输入设备等级名称!');
           				return false;
           			}
           			$.get('deviceLevel/addDeviceLevel.do',{
           			code:code,
           			name:name,
...
<sec:authorize access="hasAuthority('EDIT_DEVICE_GRADE')">
    <a href="javascript:void(0)"
       data-toggle="topjui-menubutton"
       data-options="method: 'openDialog',
            extend: '#departmentDg-toolbar',
            ...
            dialog: {
                ...
                width: 600,
                height: 400,
                href: 'console/jsp/deviceManagement/deviceLevel_edit.jsp',
                url:'deviceLevel/queryDeviceLevelById.do?id={id}',
                 buttons:[
           	{text:'编辑',handler:function(){
           			...
           			$.get('deviceLevel/updateDeviceLevel.do',{
...
<sec:authorize access="hasAuthority('DEL_DEVICE_GRADE')">
    <a href="javascript:void(0)"
       data-toggle="topjui-menubutton"
       data-options="method:'doAjax',
       extend: '#departmentDg-toolbar',
       iconCls:'fa fa-trash',
       url:'deviceLevel/deleteDeviceLevel.do',
