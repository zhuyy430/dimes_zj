        ...
        <!-- 设备点检 -->
            <div data-options="region:'center',title:'',fit:false,split:true,border:false,bodyCls:'border_bottom'"
                ...
                data-toggle="topjui-datagrid"
                       ...
                       url:'deviceProject/queryDeviceProjectByType2.do?type=MAINTAIN',
                       singleSelect:true,
                       fitColumns:true,
                       pagination:true,
...
<sec:authorize access="hasAuthority('ADD_MAINTAINPROJECT')">
...
<sec:authorize access="hasAuthority('EDIT_MAINTAINPROJECT')">
    <a href="javascript:void(0)"
       data-toggle="topjui-menubutton"
       data-options="method: 'openDialog',
            extend: '#departmentDg-toolbar',
...
<sec:authorize access="hasAuthority('DEL_MAINTAINPROJECT')">
    <a href="javascript:void(0)"
       data-toggle="topjui-menubutton"
...
<sec:authorize access="hasAuthority('IMPORT_MAINTAINPROJECT_DOC')">
    <a href="javascript:void(0)"
       data-toggle="topjui-menubutton"
       data-options="method: 'openDialog',
            extend: '#departmentDg-toolbar',
...
<sec:authorize access="hasAuthority('EXPORT_MAINTAINPROJECT_DOC')">
