...
<div data-toggle="topjui-layout" data-options="fit:true">
	<div
		...
		<form id="addDeviceForm" method="post">
			<div title="点检项目-编辑" data-options="iconCls:'fa fa-th'">
				<div class="topjui-fluid">
				<div style="height:20px;"></div>
					<div class="topjui-row">
						<div class="topjui-col-sm10">
							<label class="topjui-form-label" style="text-align: center;">点检项目</label>
							<div class="topjui-input-block">
							    <input id="name" name="name" data-toggle="topjui-textbox"
					...
					<div class="topjui-row">
						<div class="topjui-col-sm10">
							<label class="topjui-form-label" style="text-align: center;">上限值</label>
							<div class="topjui-input-block">
								<input type="number" name="upperLimit" data-toggle="topjui-textbox"
									 id="upperLimit">
							</div>
						</div>
					</div>
					<div class="topjui-row">
						<div class="topjui-col-sm10">
							<label class="topjui-form-label" style="text-align: center;">下限值</label>
							<div class="topjui-input-block">
								<input type="number" name="lowerLimit" data-toggle="topjui-textbox"
									 id="lowerLimit">
							</div>
						</div>
					</div>
