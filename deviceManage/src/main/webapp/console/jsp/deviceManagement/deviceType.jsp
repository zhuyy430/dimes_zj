            ...
            <div data-options="region:'center',title:'',fit:false,split:true,border:false,bodyCls:'border_bottom'"
                ...
                data-toggle="topjui-datagrid"
                    ...
                    <tr>
                        ...
                        <th data-options="field:'parentCode',title:'上级类别代码',width:'180px',align:'center',formatter:function(value,row,index){
                        	if(row.parent){
                        ...
                        <th data-options="field:'parentName',title:'上级类别名称',width:'180px',align:'center',formatter:function(value,row,index){
                        	if(row.parent){
...
<sec:authorize access="hasAuthority('ADD_DEVICE_TYPE')">
    <a href="javascript:void(0)"
       ...
       dialog:{
           ...
           width:600,
           height:600,
           href:'console/jsp/deviceManagement/deviceType_add.jsp',
           buttons:[
           	{text:'保存',handler:function(){
           			var code = $('#code').val();
           			if(code==null || ''===$.trim(code)){
           				$.iMessager.alert('提示','请输入设备类别代码!');
           				return false;
           			}
...
<sec:authorize access="hasAuthority('EDIT_DEVICE_TYPE')">
    <a href="javascript:void(0)"
       data-toggle="topjui-menubutton"
       data-options="method: 'openDialog',
            extend: '#departmentDg-toolbar',
            ...
            dialog: {
                ...
                width: 600,
                height: 400,
                href: 'console/jsp/deviceManagement/deviceType_edit.jsp',
...
<sec:authorize access="hasAuthority('DEL_DEVICE_TYPE')">
    <a href="javascript:void(0)"
       data-toggle="topjui-menubutton"
       ...
       onSuccess:function(){$('#departmentTg').treegrid('reload');}">删除</a>
</sec:authorize>
    </div>
</body>
</html>