				...
				<div class="topjui-fluid">
					...
					<div class="topjui-row">
						<div class="topjui-col-sm12">
							...
							<div class="topjui-input-block">
								<input id="equipmentTypeCode" name="equipmentTypeCode" data-toggle="topjui-textbox" >
						...
						<div class="topjui-col-sm12">
							...
							<input id="pressLightTypeName" data-toggle="topjui-combobox" name="pressLightTypeName"
								...
								onSelect:function(rec){
                                    ...
                                    $('#pressLightReason').iCombobox('reload', url);
								}">
					...
					<div class="topjui-row">
						<div class="topjui-col-sm12">
							...
							<div class="topjui-input-block">
								<input id="pressLightReason" data-toggle="topjui-combobox" name="pressLightReason"
                                    data-options="valueField:'id',textField:'reason',
                                    onSelect:function(rec){
                                        $('#pressLightId').val(rec.id);
                                    }
                                    ">
                                    <input type="hidden" id="pressLightId" name="pressLightId" />
							</div>
						</div>
					</div>
					<div class="topjui-row">
