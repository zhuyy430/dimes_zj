...
@RestController
@RequestMapping("/paperLessSparepart")
public class PaperLessSparepartController {
	@Autowired
	...
	@ResponseBody
	public List<Sparepart> queryOtherSpareparts(Long maintenancePlanRecordId,String sparepartCode,String sparepartName,String sparepartUnitType) {
		...
		List<Sparepart> list = sparepartService.queryOtherSpareparts(hql,args);
		return list;
	}
	/**
	 * 根据条件查询 备件信息
