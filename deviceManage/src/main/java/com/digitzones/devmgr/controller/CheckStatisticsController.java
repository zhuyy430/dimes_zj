...
public class CheckStatisticsController {
	...
	public List<CheckStatisticsVo> statisticsReport(Principal principal,String from,String to,String cycle){
		...
		List<String[]> statisticsData = checkingPlanRecordService.queryStatisticsData(from,to,cycle);
	...
	public void exportStatistics(Principal principal,String from,String to,String cycle,HttpServletResponse response){
		...
		HSSFWorkbook workBook = ExcelUtil.getHSSFWorkbook4PivotGrid("点检完成状况统计", titles,subTitles, dataList,4);
		try {
			this.setResponseHeader(response, "点检完成状况统计.xls");
