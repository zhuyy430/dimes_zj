 ...
 * 采购订单子表
 */
public class PO_PodetailsVo {
	/*采购订单子表标识（key）*/
	private Integer id;
	/*采购订单id*/
	private String poId;
	/**采购订单主表*/
	private PO_Pomain po_pomain;
	/**采购订单号*/
	...
	public PO_Pomain getPo_pomain() {
		return po_pomain;
	}

	public void setPo_pomain(PO_Pomain po_pomain) {
		this.po_pomain = po_pomain;
	}
