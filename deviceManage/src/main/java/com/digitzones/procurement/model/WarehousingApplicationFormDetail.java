...
public class WarehousingApplicationFormDetail implements Serializable {
	...
	private String id;
	/**采购订单子表记录id*/
	private Integer po_poDetailId;
	/**入库申请单*/
	@ManyToOne
    @JoinColumn(name="WAREHOUSINGAPPLICATIONFORM_CODE")
	private WarehousingApplicationForm warehousingApplicationForm;
    /**采购单号*/
    ...
    public Integer getPo_poDetailId() {
        return po_poDetailId;
    }
    public void setPo_poDetailId(Integer po_poDetailId) {
        this.po_poDetailId = po_poDetailId;
    }
    ...
    public WarehousingApplicationForm getWarehousingApplicationForm() {
        return warehousingApplicationForm;
    }
    public void setWarehousingApplicationForm(WarehousingApplicationForm warehousingApplicationForm) {
        this.warehousingApplicationForm = warehousingApplicationForm;
    }
