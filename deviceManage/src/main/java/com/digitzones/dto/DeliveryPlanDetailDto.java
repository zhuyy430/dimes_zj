...
public class DeliveryPlanDetailDto implements Serializable {
	...
	private Date deliverDateOfPlan;
	/**销售订单编号*/
    ...
    public Date getDeliverDateOfPlan() {
        return deliverDateOfPlan;
    }

    public void setDeliverDateOfPlan(Date deliverDateOfPlan) {
